 ...
 *       &amp;lt;sequence&amp;gt;
 *         &amp;lt;element ref="{}FormPattern" maxOccurs="unbounded"/&amp;gt;
 *       &amp;lt;/sequence&amp;gt;
 *     &amp;lt;/restriction&amp;gt;
 *   &amp;lt;/complexContent&amp;gt;
 * &amp;lt;/complexType&amp;gt;
...
@XmlRootElement(name = "FormPatterns")
public class FormPatterns {
     ...
     * This is why there is not a &lt;CODE&gt;set&lt;/CODE&gt; method for the formPattern property.
     *
     * &lt;p&gt;
     * For example, to add a new item, do as follows:
     * &lt;pre&gt;
     *    getFormPattern().add(newItem);
     * &lt;/pre&gt;
     *
     *
     * &lt;p&gt;
     ...
     *
     */
    public List<FormPattern> getFormPattern() {
        if (formPattern == null) {
            formPattern = new ArrayList<FormPattern>();
        }
